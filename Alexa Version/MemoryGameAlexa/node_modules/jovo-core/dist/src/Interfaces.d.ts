import { SpeechBuilder, TestSuite, RequestBuilder, ResponseBuilder, ExtensibleConfig, Jovo } from './index';
...
export declare type HandlerReturnType = Function | Promise<Function> | Promise<Jovo> | Promise<void> | void;
