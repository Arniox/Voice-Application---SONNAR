...
import { Geolocation, PermissionStatus, LocationServices, LocationServicesAccess, LocationServicesStatus, Coordinate, Altitude, Heading, Speed } from "./AlexaRequest";
