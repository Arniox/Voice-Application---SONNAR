...
class DialogflowPlugin extends jovo_core_1.Extensible {
    constructor(config, factory) {
        ...
        this.type = (jovo) => {
            if (jovo.$request && (!jovo.$type.type || jovo.$type.type === jovo_core_1.EnumRequestType.UNKNOWN_REQUEST)) {
                if (jovo.$request.getIntentName() === 'Default Welcome Intent') {
                    jovo.$type = {
                        type: jovo_core_1.EnumRequestType.LAUNCH
                    };
                }
                else if (!jovo.$type.type || jovo.$type.type === jovo_core_1.EnumRequestType.UNKNOWN_REQUEST) { //TODO:
                    jovo.$type = {
