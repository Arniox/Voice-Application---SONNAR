...
class GoogleAction extends jovo_core_1.Jovo {
    ...
    hasWebBrowserInterface() {
        ...
        const currentGoogleActionRequest = currentDialogflowRequest.originalDetectIntentRequest.payload;
    ...
    hasInteractiveCanvasInterface() {
        ...
        return typeof _get(this.$originalRequest || this.$request, 'surface.capabilities')
            .find((item) => item.name === 'actions.capability.INTERACTIVE_CANVAS') !== 'undefined';
    }
