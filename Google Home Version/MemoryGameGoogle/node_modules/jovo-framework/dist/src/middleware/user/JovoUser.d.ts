import { BaseApp, Inputs, Output, Plugin, PluginConfig, SpeechBuilder } from 'jovo-core';
...
export declare class JovoUser implements Plugin {
    ...
    loadDb: (handleRequest: any, force?: boolean) => Promise<void>;
    saveDb: (handleRequest: any, force?: boolean) => Promise<void>;
    /**
