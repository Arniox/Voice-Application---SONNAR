...
class ComponentPlugin extends jovo_core_1.Extensible {
    ...
    static loadLatestComponentSessionData(jovo) {
        if (!jovo.$session.$data[jovo_core_1.SessionConstants.COMPONENT] || jovo.$session.$data[jovo_core_1.SessionConstants.COMPONENT].length < 1) {
            return;
        }
        else {
    ...
    install(app) {
        ...
        app.middleware('after.setup').use(this.prepareHandler.bind(this), this.loadI18nFiles.bind(this));
