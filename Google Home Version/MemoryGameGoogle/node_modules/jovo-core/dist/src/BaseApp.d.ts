...
export declare type BaseAppMiddleware = 'setup' | 'request' | 'platform.init' | 'platform.nlu' | 'nlu' | 'user.load' | 'router' | 'handler' | 'user.save' | 'platform.output' | 'response' | 'fail' | string;
